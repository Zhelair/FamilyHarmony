...
Create each account manually in Supabase with **Auto confirm** enabled. A household owner then grants that existing account access in Settings. Follow [private access setup](docs/PRIVATE_ACCESS_SETUP.md) and apply all SQL migrations before using goals, challenges, reflections, Together, or private family memories.

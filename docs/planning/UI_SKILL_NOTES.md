...
- rounded cards, soft shadows, occasional warm illustration gradients
- Lucide outline icons, visible focus states, 44px touch targets, and reduced-motion support
- one clear primary action per screen and helpful empty/loading/error states
